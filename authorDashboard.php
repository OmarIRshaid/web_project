...
<html lang="en">
  ...
  <body class="authorDash">
    ...
    <div class="container">
      <div class="headerr">
        <h1 class="text-center display-4">My News</h1>
        <a href="addNewsForm.php" class="btn btn-info">ADD NEWS</a>
        </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="updateNewsForm.php" method="post" style="display: inline;">
                <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']) ; ?>">
                <button type="submit" class="btn btn-success">Update</button>
              </form>
              <form action="deleteNews.php" method="post" style="display: inline;">
                <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']) ; ?>">
